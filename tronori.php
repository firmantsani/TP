...
$wallet = 'TEVHHN'.$nomor1.'2JWDphZ'.$huruf.'stlowPMYW'.$nomor2.'qUiBk'.$huruf1.''.$huruf2.''.$huruf3.'d';
//var_dump($wallet);
//die();
$data = '{"address":"'.$wallet.'","deviceId":"'.$huruf.''.$nomor1.':'.$huruf1.''.$nomor2.':'.$nomor3.''.$huruf2.':'.$nomor2.'2:'.$huruf3.''.$nomor5.':5'.$nomor1.'","system":"Android","invitedCode":"'.$reff.'"}';
$str = strlen($data);
